...
# TODO: create setup.py for l2logger itself
import os
import sys
import json
import time
import shutil
import trivial_helper
from trivial_helper import LoggerInfo, RegimeInfo
